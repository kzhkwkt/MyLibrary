...
Pod::Spec.new do |s|
  ...
  # s.authors          = { "kwakata" => "kwakata@sonix.asia", "other author" => "email@address.com" }
  # s.author           = 'kwakata', 'other author'
  # s.social_media_url = "http://twitter.com/kwakata"
  ...
  s.source       = { :git => "https://github.com/kzhkwkt/MyLibrary.git", :tag => "0.0.1" }
